function path_v_fullgrow(filename, epsmin, numtrials, rho, load_dir)
% path_v_fullgrow(filename, epsmin, numtrials, rho, load_dir)
%
% Comparing ppr_path_rho and pprgrow for time and number of eps values
% on dataset = input 'filename'.
%
% Default value for rho is 0.0.
%
...
for trial_id=1:numtrials,
    ...
    alg_id = 2;
    tic;
    [bestset1,cond1,cut1,vol1] = pprgrow(A,node,'expands',[1:10000],'alpha',alpha);
    times(trial_id, alg_id) = toc;
