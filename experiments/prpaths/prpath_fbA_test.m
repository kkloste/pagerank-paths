...
smallest_eps_gap = 10*epsmin ; % for faster testing
...
print(gcf,['./figures/fbA-path-rho', dummy ,'TEST.png'],'-dpng','-r600');
fprintf('\n paths done.\n');
...
print(gcf,['./figures/fbA-cond-rho', dummy ,'TEST.png'],'-dpng','-r600');
