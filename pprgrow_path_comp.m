...
%   200, 300, 400, 500, 1000, 1500, 2000, 3000, 4000, 5000, and 10000
%   additional edges for each vertex in the original set of vertices.  
...
%expands = expands(1:23); % this is an ad-hoc way to get just eps values as strict as 1e-5
%
expands = [10000];
